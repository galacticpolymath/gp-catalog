...
search_attributes = keys = ['id','GPCatalogPath','ShortTitle','PublicationStatus','ReleaseDate', 'LastUpdated', 'FirstPublicationDate', 'Title', 'Subtitle', 'SponsoredBy', 'Tags','Description','Standards']
